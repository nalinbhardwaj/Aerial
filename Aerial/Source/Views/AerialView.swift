...
/*
  ...
  */
    ...
    override func keyDown(with event: NSEvent) {
		...
		} else if preferences.showDescriptions && preferences.showDescriptionsMode == Preferences.DescriptionMode.fade10seconds.rawValue && preferences.showDescriptionsOnKeypress && event.keyCode == 42 {
				if !isQuickFading {
